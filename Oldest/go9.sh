...
usage="Usage: go9.sh -p <geom_provider> -s <swap_partition_size> -S <zfs_partition_size> -n <zpoolname> -m <zpool-raidmode> -d <distdir> -f <ftphost>"
...
zfs create -o compression=lzjb	-o exec=on	-o setuid=off	$poolname/usr/ports
